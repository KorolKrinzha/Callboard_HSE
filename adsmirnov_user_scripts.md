...
1. События, созданные пользователем, представляют из себя те же события,  что изображены на главной странице, только на экране будут отображаться те события, на которых ранее подписался пользователь. Поэтому пользователь сможет пролистывать все события также, как и в главном меню.
...
4. Пользователь сможет редактировать каждый пункт своего события. 
...
8. Пользователь может удалить свое событие. При нажатии большой опасной красной кнопки "УДАЛИТЬ" система выводит сообщение: "Вы точно уверены, что хотите удалить событие?"
9. При нажатии на кнопку "Да" данное событие удаляется из общего списка, а сам пользователь возвращается на страницу главного меню.
10.  При нажатии на кнопку "Нет" данное событие остается в списке всех событий, а пользователь остается на странице данного события.
...
3. На странице конкретного события можно увидеть всю необходимую информацию о событии (см Сценарий 4)
4. В отличие от любых других событий, в посещаемых пользовать может нажать на кнопку "Отказаться от участия". После нажатия система выдаст предупреждение: "Вы уверены, что хотите отказаться от участия в событии?".
...
7. Данные  события находятся в одной из вкладок приложения, поэтому пользователь сможет спокойно перемещаться  по другим вкладкам, создать события и т.д.
...
4. Обычные пользователи также могут сделать так, чтобы их событие попало в "Избранное". Достаточно написать  разработчикам в любую социальную сеть, указанную в Настройках профиля.
...
2. В своем личном профиле пользователь сможет редактировать о своем профиле.
